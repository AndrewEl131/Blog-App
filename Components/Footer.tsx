...
export default function Footer() {
  return (
    <footer className="bg-(--color-primary) text-(--color-text) w-full flex justify-evenly items-center py-10">
        <div>
            <Image src={'/icons/blogApp-icon-med.png'} width={120} height={100} alt="logo" />
        </div>
